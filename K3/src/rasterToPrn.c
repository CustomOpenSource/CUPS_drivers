...
static const struct command CutCommand [5] = {
    {6, (char[6]){0x1C, 0xC0, '3', 0x1C, 0xC0, '7'}},     // Tear off
    {6, (char[6]){0x1C, 0xC0, '1', 0x1C, 0xC0, '7'}},     // Total cut at end page
    {6, (char[6]){0x1C, 0xC0, '2', 0x1C, 0xC0, '7'}},     // Partial cut at end page
    {6, (char[6]){0x1C, 0xC0, '1', 0x1C, 0xC0, '7'}},     // Total cut at end doc
    {6, (char[6]){0x1C, 0xC0, '2', 0x1C, 0xC0, '7'}}      // Partial cut at end doc
};
