...
static const struct command Darkness [9] = {
...
static const struct command ForceEscPosEmulation = {
    8, (char[8]){0x18, 0x1C, 0x3C, 'E', 'P', 'O', 'S', 0x3E}
};

// cutter mode commands
static const struct command CutterModeCommand = {
    6, (char[6]){0x1C, 0xC0, '1', 0x1C, 0xC0, '0'}
};
...
static const struct command EjectCommand = {
    3, (char[3]){0x1D, 0x65, 0x05}
};

static const struct command PresentationCommand = {
    4, (char[4]){0x1D, 0x65, 0x03, 0xFF}
};

// tear off command
static const struct command TearOffCommand = {
    6, (char[6]){0x1C, 0xC0, '1', 0x1C, 0xC0, '0'}
};

// tear off distance command
static const struct command TearOffDistanceCommand[13] = {
    {10, (char[10]){0x1C, 0xC0, 'T', 0x0F, 0x1C, 0xC0, '9', 0x1C, 0xC0, 'L'}},          // -4 mm 
    {10, (char[10]){0x1C, 0xC0, 'T', 0x11, 0x1C, 0xC0, '9', 0x1C, 0xC0, 'L'}},          // -2 mm 
    {10, (char[10]){0x1C, 0xC0, 'T', 0x13, 0x1C, 0xC0, '9', 0x1C, 0xC0, 'L'}},          //  0 mm 
    {10, (char[10]){0x1C, 0xC0, 'T', 0x15, 0x1C, 0xC0, '9', 0x1C, 0xC0, 'L'}},          //  2 mm 
    {10, (char[10]){0x1C, 0xC0, 'T', 0x17, 0x1C, 0xC0, '9', 0x1C, 0xC0, 'L'}},          //  4 mm 
    {10, (char[10]){0x1C, 0xC0, 'T', 0x19, 0x1C, 0xC0, '9', 0x1C, 0xC0, 'L'}},          //  6 mm 
    {10, (char[10]){0x1C, 0xC0, 'T', 0x1B, 0x1C, 0xC0, '9', 0x1C, 0xC0, 'L'}},          //  8 mm 
    {10, (char[10]){0x1C, 0xC0, 'T', 0x1D, 0x1C, 0xC0, '9', 0x1C, 0xC0, 'L'}},          // 10 mm 
    {10, (char[10]){0x1C, 0xC0, 'T', 0x1F, 0x1C, 0xC0, '9', 0x1C, 0xC0, 'L'}},          // 12 mm 
    {10, (char[10]){0x1C, 0xC0, 'T', 0x21, 0x1C, 0xC0, '9', 0x1C, 0xC0, 'L'}},          // 14 mm 
    {10, (char[10]){0x1C, 0xC0, 'T', 0x23, 0x1C, 0xC0, '9', 0x1C, 0xC0, 'L'}},          // 16 mm 
    {10, (char[10]){0x1C, 0xC0, 'T', 0x25, 0x1C, 0xC0, '9', 0x1C, 0xC0, 'L'}},          // 18 mm 
    {10, (char[10]){0x1C, 0xC0, 'T', 0x27, 0x1C, 0xC0, '9', 0x1C, 0xC0, 'L'}}           // 20 mm 
};

// define recovery command
static const struct command RecoveryCommand [4] = {
    {3, (char[3]){0x1C, 0xC1, 0x00}},           /* empty command */           
    {3, (char[3]){0x1C, 0xC1, 0x0F}},                     
    {3, (char[3]){0x1C, 0xC1, 0x18}},                     
    {3, (char[3]){0x1C, 0xC1, 0xFF}}
};                   
...
int main(int argc, char *argv[]) {
    ...
    while (cupsRasterReadHeader2(rasterFileStruct, &cupsHeader)){
        ...
        if (settings.recoveryMode >= 0)
            SendCommand(RecoveryCommand[settings.recoveryMode]);
        ...
        // SEND CUT COMMAND
	    if (settings.cutterMode == 0) {
		    SendCommand(CutterModeCommand);
		}
    ...
    if( settings.presentation == 1 || settings.presentation == -1 )
        SendCommand(EjectCommand);

    if (settings.presentation == 0)
        SendCommand(PresentationCommand);
	
    // SEND CUT COMMAND
	if(settings.tearOffDistance != -1){
        SendCommand(TearOffCommand);
    }
