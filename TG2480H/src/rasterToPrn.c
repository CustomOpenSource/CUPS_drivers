...
static const struct command Darkness [5] = {
    {5, (char[5]){0x1B, '&', 'k', '0', 'W'}},          // 0 -25 %
    {5, (char[5]){0x1B, '&', 'k', '1', 'W'}},          // 1 -12.5 %
    ...
    {5, (char[5]){0x1B, '&', 'k', '7', 'W'}},          // 0 -25 %
    {5, (char[5]){0x1B, '&', 'k', '8', 'W'}}           // 1 -12.5 %
};

// page cut type commands
static const struct command CutCommand [3] = {
    {10, (char[10]){0x0A, 0x0A, 0x0A, 0x1C, 0xC0, 0xAA, 0x0F, 0xEE, 0x0B, '3'}},   // no cut
    {7, (char[7]){0x1C, 0xC0, 0xAA, 0x0F, 0xEE, 0x0B, '4'}},   // cut and recovery
    {7, (char[7]){0x1C, 0xC0, 0xAA, 0x0F, 0xEE, 0x0B, '5'}}    // cut without recovery
};
...
// notch command 
static const struct command notchAlignment[2] = {
...
int main(int argc, char *argv[]) {
    ...
    // SEND CUT COMMAND
	if (settings.cutterMode == 0 || settings.cutterMode == 3 || settings.cutterMode == 4) {
